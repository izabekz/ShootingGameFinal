...
public enum SoundEffects {
    ...
    public void setContext(Context context) {
       ...
       // Adding sounds corresponding to the bullet and Android Guy
        mSoundPoolMap.put(SOUND_BULLET, mSoundPool.load(context, R.raw.beep4,2));
        mSoundPoolMap.put(SOUND_GUY, mSoundPool.load(context, R.raw.beep9,3));
